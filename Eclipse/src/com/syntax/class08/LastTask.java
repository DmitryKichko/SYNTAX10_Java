...
public class LastTask {
	...
	public static void main(String[] args) {
		/*
		 * Написать программу, которая просит пользователя ввести товар, 
		 * который он хочет купить, и цену на этот товар. 
		 * Каждый раз, когда пользователь вводит деньги, накапливать их сумму и сообщать
		 * пользователю, сколько осталось до погашения. 
		 * Если пользователь вводит больше денег, программа должна возвращать сдачу. 
		 * По окончании оплаты программа должна сказать. 
		 * "Спасибо за покупку!"
		 */
