...
public static void main(String[] args) {
	/*
	 * Написать программу, которая просит пользователя ввести значение для продажи: да или нет 
	 * если продажи нет --> вы не пойдете за покупками 
	 * если продажа есть --> попросить пользователя ввести цену товара 
	...
	if(sale.equals("yes")) {
		...
		System.out.println("После скидки "+discount+"% цена товара"+"уменьшен с $"+price+"до "+finalPrice);
