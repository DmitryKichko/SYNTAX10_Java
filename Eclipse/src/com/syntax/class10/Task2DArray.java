...
//---------------------------------------- Как получить доступ ко всем элементам ---------------------------------------
         ...
         * - первая строка которого будет содержать 4 фамилии,
         *   а вторая строка будет содержать оценки.
         *
         * - Затем программа должна вывести имена студентов,
         *   которые имеет оценки A и B
         */
    }
}