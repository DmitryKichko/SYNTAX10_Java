package com.syntax.class02.hwAndTask;
...
public class Task2 {
	...
	public static void main(String[] args) {
		...
		result = n1 + n2;
		String act = "add"; 
		System.out.println("The " + act + " of 2 numbers " + "of 2 numbers "+ n1 + " and " + n2 + " is equal to "+ result );
		 ...
		 */
	     ...
	     System.out.println("The peruneter of a rectangle with width " + width + 
	    		 " and height " + "is equel to " + perimeter + " and the area is " + area);
